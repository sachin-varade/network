...
// join.joinChannel("mychannel", ["peer1"], "Jim", "org2")
//     .then(function(message) {
//         console.log(message);
//     });
...
/////
    ...
    //                     console.log(message);
                        ...
                        // invoke.invokeChaincode(["peer1","peer2"], "farmerschannel", "farmersCC", "createPart", ["P001", "C001", "01-01-2017", "Jim", "Break", "Break", "na", "B001", "" ], "admin", "org1")
                        // .then(function(message) {
                        //     console.log(message);
                        ...
                        // query.queryChaincode("peer2", "farmerschannel", "farmersCC", [""], "getAllParts", "Jim", "org1")
                        //     .then(function(message) {
                        //         console.log(message);
                        //     });

                        // query.queryChaincode("peer1", "processorschannel", "processorsCC", [""], "getAllVehicles", "Jim1", "org4")
                        // .then(function(message) {
                        //     console.log(message);
                        // });
